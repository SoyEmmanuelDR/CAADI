                ...
                <tbody>
                    <?php while ($row = $registros->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><?= $row['horas'] ?></td>
                            <td class="acciones">
                                <a class="editar" href="editarEstudiante.php?no_control=<?= $row['id'] ?>">
                                    <img src="../imagenes/icon-edit.png" alt="Editar" width="20" height="20" title="Editar">
                                </a>
                                <a class="eliminar" href="eliminarEstudiante.php?no_control=<?= $row['id'] ?>" onclick="return confirm('¿Estás seguro de eliminar este estudiante?')">
